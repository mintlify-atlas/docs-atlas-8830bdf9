...
AWS Security Group Auditor is a powerful Python CLI tool designed to help you maintain a clean and secure AWS infrastructure by identifying security groups that are no longer in use. The tool performs a comprehensive audit across 25+ AWS services, tracking which security groups are actively attached to resources and which are orphaned.
...
<CardGroup cols={2}>
  <Card title="Comprehensive scanning" icon="magnifying-glass">
    Audits security groups across 25+ AWS services including EC2, RDS, ECS, EKS, Lambda, ElastiCache, and more
  </Card>
...
- **Compute**: EC2 instances, ECS services, EKS clusters, Elastic Beanstalk, Lambda
